...
def add_income(request):
    ...
    required_fields = ['amount', 'description', 'date', 'source']
    ...
    messages.success(request,'Income is created successfully')
...
def delete_income(request,id):
    income = UserIncome.objects.get(pk=id)
    income.delete()
    messages.success(request,'Income is deleted successfully')
    return redirect('income')